...
function App() {
  ...
  const command = 'This sentence is encountering Plagiarism, please can you modify or restructure it so that plagiarism can be avoided. And strict instruction are that you need to dont reduce pararaph length. Keep paragraph length as it is.'
  ...
  return (
    <div className=' text-white w-[660px] h-[400px] font-mono '>
      ...
      <h2 className='text-3xl py-4 font-bold'>Plagiarism Remover</h2>
        ...
        <button className='h-10 w-44 bg-green-400 border-2 border-black rounded-md' onClick={generateAnswer} >Plagiarsim Remover</button>
        {
          showLoader ? (
            <Loader/>
          ) : (
